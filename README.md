...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 56](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-56) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. An exact-brand Yandex Web Search query first returned the official Onyx apex domain, whose live canonical points to the Hong Kong site; the same result set also exposed the Onyx GitHub organization and Hong Kong Companies Registry record. A follow-up `site:hk.onyxdevslab.com` query encountered SmartCaptcha and was not interpreted. Hong Kong subdomain and non-brand retrieval, AI citation, recommendation, independent endorsement, and a human visit remain unverified; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_56) remains mutable.
