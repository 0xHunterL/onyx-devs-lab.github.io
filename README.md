...
- [Automated GEO monitor evidence checkpoint — 2026-09-11, revision 3](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-11-3) — current and rotated-log evidence with a [machine-readable snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-3/2026-09-11-monitor-evidence.json): seven verified OAI-SearchBot discovery-file requests, zero OAI search content requests, 68 attribution candidates classified as 59 suspected automated requests and nine visitor-type-unverified requests, and no observed public-site indexing, AI citation, or non-brand recommendation.
