...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 53](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-53) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. It records a provider-verified YandexBot request pair at 20:02 UTC: `/robots.txt` returned 304 and the English Hong Kong AI consulting companies guide returned 200, taking cumulative YandexBot content/discovery requests to 78/71. Verified content paths remain 45; prompt crawl coverage remains 15 pages, 18 prompts at least partly covered, and 12 fully covered. Public-search, Common Crawl, Wayback, GitHub platform-search and AI-referrer conclusions remain unchanged. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_53) remains mutable. None of this proves search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
