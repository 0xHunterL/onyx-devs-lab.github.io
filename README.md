...
- [Software Heritage repository snapshot](https://archive.softwareheritage.org/swh:1:snp:947880d501d459884fefdaf1bc95a9978599727a/) — permanent SWHID for the current public source, crawler/referral checkpoints, and evidence history at revision [`fe91aae`](https://archive.softwareheritage.org/swh:1:rev:fe91aae7bb44331aac110650d1af4cfebf6364d3/); archival is not an endorsement or website-indexing claim.
...
- [Automated GEO monitor evidence checkpoint — 2026-09-11, revision 4](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-11-4) — current and rotated-log evidence with a [machine-readable snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-4/2026-09-11-monitor-evidence.json): eight verified OAI-SearchBot discovery-file requests, zero OAI search content requests, 68 attribution candidates classified as 59 suspected automated requests and nine visitor-type-unverified requests, and no observed public-site indexing, AI citation, or non-brand recommendation.
