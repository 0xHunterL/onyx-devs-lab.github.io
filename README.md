...
- [Automated GEO monitor evidence checkpoint — 2026-09-11, revision 2](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-11-2) — current and rotated-log evidence with a [machine-readable snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-2/2026-09-11-monitor-evidence.json): seven verified OAI-SearchBot discovery-file requests, zero OAI search content requests, 52 attribution candidates classified as 45 suspected automated requests and seven visitor-type-unverified requests, and no observed public-site indexing, AI citation, or non-brand recommendation.
