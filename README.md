...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 68](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-68) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. This revision adds a provider-attributed Bing check: the exact public retrieval marker returned an explicit no-results page, while exact-brand and `site:` queries broadened to unrelated “Onyx” results and did not expose the official site on the first page. It also separates neutral category discovery from FDE-branded queries so FDE.HK does not confound the baseline. The prior Software Heritage, Wayback, and verified-crawler evidence remains unchanged. These observations do not prove exhaustive deindexing, ranking, Copilot or other AI retrieval, citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_68) remains mutable.
- Historical checkpoint: [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 67](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-67), with its [tracked live-status target](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_67). Use revision 68 for the current provider-attributed search baseline.
