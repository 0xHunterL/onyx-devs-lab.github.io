...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 51](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-51) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. It records 11 provider-verified OAI-SearchBot discovery-file requests, 77 YandexBot content requests, 70 YandexBot discovery-file requests, and 93 AhrefsBot discovery-file requests; the 23-prompt crawl coverage remains 15 evidence pages, 18 prompts at least partly covered, and 12 fully covered. The available Wayback CDX result currently contains 92 captures across 43 URLs, while the append-only archive ledger retains independently verified historical observations and prompt archive coverage remains 15 pages, 15 prompts with any archive, and 11 fully archived. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_51) remains mutable. None of this proves search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
