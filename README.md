...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 62](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-62) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It records one new provider-verified AhrefsBot `/sitemap.xml` request, taking verified discovery-file requests to 98 while AhrefsBot content requests remain zero. Both selected Common Crawl indexes returned usable zero-capture responses after the prior outage. Verified coverage remains 45 paths, 15 search-related evidence pages, and 18 prompts with at least one crawled evidence page. This is monitoring-integrity and source-availability evidence only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_62) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 61](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-61) preserves three visitor-type-unverified requests and the nonblocking optional-archive availability policy. It does not prove a human visit, indexing, AI citation, or non-brand recommendation.
