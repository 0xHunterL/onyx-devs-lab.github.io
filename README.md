...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 73](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-73) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. At `09:49:52Z`, a direct Bing exact-brand query showed the official apex and both Hong Kong localized homepages in the first visible results. The legacy HTTP apex result still carried a stale personal-profile snippet, the legal-name query showed third-party entity records without the official site in the inspected subset, and the neutral `"Hong Kong AI consulting"` query did not show Onyx in the visible first page. The previous negative checkpoint is retained as history and is not treated as a stable ranking trend. These observations do not prove exhaustive indexing across all regions or pages, stable ranking, Copilot or other AI retrieval, citation, recommendation, or independent endorsement; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_73) remains mutable.
