...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 48](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-48) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. The 23-prompt protocol covers all six published cases; against the same production report, 15/23 evidence pages have provider-verified search-related crawler requests, 18/23 prompts are at least partly covered, and 12/23 are fully covered. Wayback has 93 captures across 43 URLs and covers 15/23 prompt evidence pages. The change from the historical 20-prompt denominator is a protocol expansion, not new crawler activity. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_48) remains mutable. None of this proves search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
