...
- [Automated GEO monitor evidence checkpoint — 2026-09-11, revision 7](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-11-7) — evidence collected from the then-retained active and rotated logs, preserved in a [machine-readable snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-7/2026-09-11-monitor-evidence.json): 27 verified GPTBot content requests, 13 GPTBot discovery-resource requests after a historical path-classification correction, eight verified OAI-SearchBot discovery-file requests, zero OAI search content requests, zero non-synthetic Bytespider candidates, and 70 attribution candidates classified as 61 suspected automated requests and nine visitor-type-unverified requests. The correction reclassifies earlier requests rather than recording new crawler activity; no public-site indexing, AI citation, or non-brand recommendation was observed.
