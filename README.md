...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 61](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-61) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It records three new no-referrer `geo_engagement_model_qa` requests, taking tracked requests to 86 and visitor-type-unverified requests to 14 while AI Referrer remains zero. Both selected Common Crawl indexes returned HTTP 504; optional archive availability remains event-recorded but does not independently block unrelated verified evidence publication. Verified coverage remains 45 paths, 15 search-related evidence pages, and 18 prompts with at least one crawled evidence page. This is monitoring-integrity and source-availability evidence only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_61) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 60](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-60) preserves the continuous numbered-log lineage policy and partial Common Crawl observation after midnight rotation. It does not prove indexing, AI citation, or non-brand recommendation.
