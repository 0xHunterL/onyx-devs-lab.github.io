...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 71](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-71) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. At `06:16:57Z`, provider-verified GPTBot fetched `/sitemap.xml` with HTTP 200 and OAI-SearchBot fetched `/robots.txt` with HTTP 304, bringing discovery-file counts to 15 and 12; OAI-SearchBot content requests remain zero. Revision 70’s independent Software Heritage snapshot remains valid for revision `d7d6ee3`, while the later publication commit makes current archive coverage `lagging`. These observations do not prove content crawling by OAI-SearchBot, exhaustive indexing, AI retrieval, citation, ranking, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_71) remains mutable.
