...
- [Software Heritage repository snapshot](https://archive.softwareheritage.org/swh:1:snp:df2409f12f9b01e665ae896d0492aa09148b9c1b/) — permanent SWHID preserving the functional source, crawler/referral checkpoints, and evidence history through revision [`f17606c`](https://archive.softwareheritage.org/swh:1:rev:f17606cf302d4e1368eae3f2a76c295af61384ad/); later commits may update the snapshot relation itself, and archival is not an endorsement or website-indexing claim.
...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 41](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-41) — immutable provider-maintained copies of the [monitor snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-12-41/2026-09-11-monitor-evidence.json) and [public status snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-12-41/ai-search-evidence-status.json), collected at `2026-09-12T10:04:54.078Z`. The checkpoint records 28 provider-verified GPTBot content requests, 14 GPTBot discovery requests, 10 OAI-SearchBot discovery requests, 71 YandexBot content requests, 85 AhrefsBot discovery requests, the latest complete Wayback observation of 93 captures across 43 URLs, and services.hk readiness as unavailable. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_41) remains the current mutable record. Availability does not prove search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
