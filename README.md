...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 60](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-60) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It replaces a daily false-positive drift check with a continuous numbered-log lineage policy: natural rotation growth is accepted while gaps, unexpected paths, duplicates, or a missing active log still fail. Verified coverage remains 45 paths, 15 search-related evidence pages, and 18 prompts with at least one crawled evidence page. One selected Common Crawl index returned HTTP 504, so this observation is partial. This is monitoring-integrity and source-availability evidence only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_60) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 59](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-59) preserves two official-range AhrefsBot discovery requests and the append-only verified-observation path repair. It does not prove indexing, AI citation, or non-brand recommendation.
