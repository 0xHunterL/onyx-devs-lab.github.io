...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 52](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-52) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. The 19:59 UTC public-search retest still did not expose the official site, verification marker, or an Onyx non-brand category result. The current non-brand competitor set changed from 23 to 22 observed URLs and includes Alpha Match and AIKm; prior brand and low-confidence directory results remain separately dated rather than being treated as deleted. Crawler, prompt-coverage, and archive counts remain those of revision 51. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_52) remains mutable. None of this proves search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
