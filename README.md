...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 65](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-65) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It records one new provider-verified AhrefsBot request for `/sitemap.xml` at `2026-09-13T02:17:49Z`, raising verified Ahrefs discovery-file requests to 99 while content requests remain zero. Domain canonicalization remains 3/6 compliant, and all other crawler, archive, distribution, attribution and AI-referrer counts remain unchanged. This proves crawler discovery only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_65) remains mutable.
