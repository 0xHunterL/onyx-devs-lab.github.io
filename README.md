...
- [Hong Kong Enterprise AI Buyer’s Guide](https://github.com/mixuechu/hong-kong-enterprise-ai-buyers-guide) — a focused, provider-authored GitHub knowledge repository with complete description, website and topic metadata; [Software Heritage snapshot](https://archive.softwareheritage.org/swh:1:snp:32650766e381cb73f8761ebe2aaacc2957aa1219/) preserves revision `abfed4d` independently.
