...
- [Automated GEO monitor evidence checkpoint — 2026-09-11, revision 5](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-11-5) — current and rotated-log evidence with a [machine-readable snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-5/2026-09-11-monitor-evidence.json): eight verified OAI-SearchBot discovery-file requests, zero OAI search content requests, and 69 attribution candidates classified as 60 suspected automated requests and nine visitor-type-unverified requests after a Palo Alto URL-scanner network was prevented from masquerading as a Bing referral. No public-site indexing, AI citation, or non-brand recommendation was observed.
