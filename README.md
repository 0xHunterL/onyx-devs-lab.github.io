...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 67](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-67) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. Software Heritage retry visit `2026-09-13T03:50:50.672Z` completed with a content-addressed snapshot whose `main` exactly preserves observed GitHub revision `40d2c1d`; the same collection records 101 provider-verified AhrefsBot discovery-file requests and zero AhrefsBot content requests. This proves independent code preservation and external crawler discovery only—not website indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_67) remains mutable.
