...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 49](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-49) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. It records 76 provider-verified YandexBot content requests, 69 YandexBot discovery-file requests, and 87 AhrefsBot discovery-file requests; the 23-prompt coverage remains 15 evidence pages, 18 prompts at least partly covered, and 12 fully covered. Wayback remains at 93 captures across 43 URLs. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_49) remains mutable. None of this proves search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
