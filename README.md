...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 58](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-58) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It preserves two new provider-verified YandexBot discovery requests: `/robots.txt` returned 304 and the public GitHub repository-search baseline returned 200. YandexBot discovery-file requests therefore total 73; content requests remain 78. The six-entry domain check is unchanged at three compliant and three noncompliant entries. These observations prove crawler access only, not causation, indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_58) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 57](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-57) preserves the first automated domain-canonicalization report and the [former tracked live-status target](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_57). It does not prove a ranking effect, AI citation, or non-brand recommendation.
