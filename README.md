...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 63](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-63) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It closes a distribution-monitoring gap by adding two existing public sources: the bilingual Hong Kong enterprise AI governance Gist and the versioned Chinese field-note index Release. All 10 public URLs and 24 tracked targets passed anonymous checks, for 34 available sources. Six internal manifest-audit requests were excluded after the synthetic-client classifier was generalized to `Onyx-GEO-*`; real attribution remains 86 tracked requests, 14 visitor-type-unverified requests, and zero AI Referrer. This is monitoring-integrity evidence only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_63) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 62](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-62) preserves the 98th verified AhrefsBot discovery-file request and restored selected-index Common Crawl availability. It does not prove indexing, AI citation, or non-brand recommendation.
