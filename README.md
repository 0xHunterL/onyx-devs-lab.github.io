...
- [Automated GEO monitor evidence checkpoint — 2026-09-11, revision 6](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-11-6) — current and rotated-log evidence with a [machine-readable snapshot](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-6/2026-09-11-monitor-evidence.json): eight verified OAI-SearchBot discovery-file requests, zero OAI search content requests, zero non-synthetic Bytespider candidates under a User-Agent-only identity boundary, and 70 attribution candidates classified as 61 suspected automated requests and nine visitor-type-unverified requests. No public-site indexing, AI citation, or non-brand recommendation was observed.
