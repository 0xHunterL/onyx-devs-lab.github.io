...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 57](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-57) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It preserves the Yandex exact-brand result and the first automated six-entry domain-canonicalization report: the Hong Kong host is HTTPS-canonical, while the GitHub Pages apex still serves HTTP and the HTTPS www entry downgrades to HTTP. Three of six entry points are noncompliant. This technical defect does not prove a ranking effect, and Hong Kong deep-page or non-brand retrieval, AI citation, recommendation, independent endorsement, and a human visit remain unverified; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_57) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 56](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-56) preserves the first direct Yandex exact-brand result and the [former tracked live-status target](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_56). The follow-up site query encountered SmartCaptcha and was not interpreted; this historical checkpoint does not prove AI citation or non-brand recommendation.
