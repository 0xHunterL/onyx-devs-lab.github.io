...
- [Software Heritage repository snapshot](https://archive.softwareheritage.org/swh:1:snp:a6d10e9586fcc1860acf66f32651994693d87578/) — permanent SWHID preserving revision 49 evidence assets, monitoring retry logic, citation metadata, and Git history through revision [`a2d9281`](https://archive.softwareheritage.org/swh:1:rev:a2d9281d23f406cd7ab1b19ed62d0e4c2e6fadfc/); its `geo-monitor-evidence-2026-09-12-49` tag remains pinned to the immutable evidence commit `93ad585`. Archival is not an endorsement or website-indexing claim.
...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 66](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-66) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. Wayback now exposes 96 successful HTML captures across 46 URLs, including three newly observed captures across the recruiting and credit-research case studies; 18 of 23 fixed-prompt evidence pages are archived and 15 prompts are fully archived. The new Software Heritage monitor separately records that its latest complete repository snapshot still lags GitHub `main`, and that request `2473234` is awaiting a provider-scheduled retry after GitHub returned HTTP 429. This proves public archival availability and an archive-coverage gap only—not search indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_66) remains mutable.
