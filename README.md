...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 72](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-72) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. At `07:59:58Z`, provider-verified OAI-SearchBot fetched `/robots.txt` with HTTP 304, bringing OpenAI discovery-file counts to GPTBot 15 and OAI-SearchBot 13; their content-request counts remain 28 and zero. Ahrefs discovery-file requests reached 105 while content requests remain zero. One additional GitHub Discussions UTM request is retained only as visitor-type-unverified evidence. These observations do not prove content crawling by OAI-SearchBot, exhaustive indexing, AI retrieval, citation, ranking, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_72) remains mutable.
