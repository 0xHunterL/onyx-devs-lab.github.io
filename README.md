...
- [Onyx GEO monitor evidence checkpoint — 2026-09-12, revision 54](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-54) — immutable provider-maintained copies of the monitor snapshot, public status, schema version 3 prompt matrix, evidence map, and crawler-coverage summary. It records one provider-verified AhrefsBot `/sitemap.xml` request, taking cumulative discovery-file requests to 94, and a newly exposed Wayback capture of the Simplified Chinese industrial ERP case study. Public archive coverage is now 94 captures across 44 URLs; fixed-prompt archive coverage is 16 evidence pages, 16 prompts with any archive, and 12 fully archived prompts. Content crawl coverage, Common Crawl, public search, GitHub platform search and AI-referrer conclusions remain unchanged. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_54) remains mutable. None of this proves search indexing, AI citation, non-brand recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao.
