...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 59](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-59) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It records two new official-range AhrefsBot discovery requests to `/robots.txt` and `/sitemap.xml`, bringing the total to 97, and the production repair that rebuilds 45 distinct verified content paths and fixed-prompt coverage from an append-only sanitized observation ledger across log rotation. These observations prove crawler access and monitoring continuity only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_59) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 58](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-58) preserves two provider-verified YandexBot discovery requests and the [former tracked live-status target](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_58). It does not prove causation, indexing, AI citation, or non-brand recommendation.
