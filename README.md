...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 64](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-64) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It adds authoritative DNS and public edge-header evidence to the domain canonicalization monitor: both authoritative nameservers are Cloudflare nameservers, and all six tested entry points expose Cloudflare `Server` plus `CF-Ray` signals. Three entry points remain noncompliant, including the HTTPS `www` downgrade to HTTP; these public delivery-path signals do not identify the responsible rule or authorize a configuration change. Crawler, archive, distribution, attribution and AI-referrer counts remain unchanged. This is technical monitoring evidence only, not indexing, ranking, AI citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_64) remains mutable.
- [Historical Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 63](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-63) preserves the expanded 10-publication／24-target distribution ledger and six-request internal-audit correction. It does not prove indexing, AI citation, or non-brand recommendation.
