...
- [Software Heritage repository snapshot](https://archive.softwareheritage.org/swh:1:snp:f3820205ce07ab9df33d2f0db735bc4b25ca0347/) — permanent SWHID whose `main` branch independently preserves revision [`40d2c1d`](https://archive.softwareheritage.org/swh:1:rev:40d2c1d369ec835c5012256a6f2f84964e01305b/), including revision 66 evidence assets and save-request monitoring. Archival is not an endorsement or website-indexing claim.
...
- [Onyx GEO monitor evidence checkpoint — 2026-09-13, revision 69](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-69) — immutable provider-maintained copies of the monitor snapshot, public status, prompt matrix, evidence map, and crawler-coverage summary. It records 102 provider-verified AhrefsBot discovery-file requests and zero AhrefsBot content requests, and fixes GitHub repository-search drift so ordering changes inside an unchanged result set are not misreported as evidence changes. It retains revision 68’s provider-attributed Bing check, Google challenge boundary, and neutral-category/FDE query separation. These observations do not prove exhaustive indexing or deindexing, ranking, Yep, Copilot or other AI retrieval, citation, recommendation, independent endorsement, or a human visit; no prompt was sent to Doubao. The [tracked live status](https://hk.onyxdevslab.com/data/ai-search-evidence-status.json?utm_source=github_releases&utm_medium=referral&utm_campaign=geo_monitor_evidence_69) remains mutable.
