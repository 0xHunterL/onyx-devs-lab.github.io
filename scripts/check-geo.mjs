...
if (promptCrawlCoverage.totals?.prompts !== 23 || promptCrawlCoverage.totals?.uniqueEvidencePages !== 23 || promptCrawlCoverage.totals?.verifiedCrawledEvidencePages !== 16 || promptCrawlCoverage.totals?.searchRelatedCrawledEvidencePages !== 16 || promptCrawlCoverage.totals?.promptsWithAnyVerifiedCrawl !== 18 || promptCrawlCoverage.totals?.promptsFullyVerifiedCrawled !== 12 || promptCrawlCoverage.totals?.promptsWithAnySearchRelatedCrawl !== 18 || promptCrawlCoverage.totals?.promptsFullySearchRelatedCrawled !== 12) failures.push('prompt crawl coverage: verified coverage totals are incomplete or stale');
...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-14-77')) failures.push(`${name}: automated GEO monitor evidence checkpoint is missing`);
...
try {
  ...
  if (promptMap.promptMatrix?.doubaoPromptsSent !== false || promptMap.totals?.verifiedCrawledEvidencePages !== 16 || promptMap.totals?.searchRelatedCrawledEvidencePages !== 16) failures.push('AI-search prompt evidence map: evidence boundary is incomplete');
...
try {
  ...
  const expectedVersionHistory = [
    ['2026.09.14.77', 'current-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-14-77/ai-search-evidence-status.json'],
    ['2026.09.14.76', 'previous-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-14-76/ai-search-evidence-status.json'],
    ...
    ['2026.09.13.74', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-74/ai-search-evidence-status.json'],
  ];
...
if (!machineDiscoveryFiles['feed.xml'].includes('<updated>2026-09-14T00:00:00+08:00</updated>')) failures.push('feed.xml: feed update date is stale');
