...
for (const file of htmlFiles) {
  ...
  if (!html.includes('"identifier":"swh:1:snp:10f3eebf63fd650c5844f45a4953f976d98adfa9"')) failures.push(`${relative}: missing buyer-guide archive reference`);
...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://archive.softwareheritage.org/swh:1:snp:10f3eebf63fd650c5844f45a4953f976d98adfa9/')) failures.push(`${name}: buyer-guide archive is missing`);
...
try {
  ...
  if (!organization.subjectOf?.some((item) => item.identifier === 'swh:1:snp:10f3eebf63fd650c5844f45a4953f976d98adfa9' && item.version === '0d2f08a1897b8d28ca917c269c985894d45d62f2')) failures.push('organization record: buyer-guide archive relation is missing');
