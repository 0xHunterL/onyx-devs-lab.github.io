...
for (const file of htmlFiles) {
  ...
  if (!html.includes('"identifier":"swh:1:snp:8368f6ceb7c7514e2273e3f28d44dbfca11aaddc"')) failures.push(`${relative}: missing buyer-guide archive reference`);
...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://archive.softwareheritage.org/swh:1:snp:8368f6ceb7c7514e2273e3f28d44dbfca11aaddc/')) failures.push(`${name}: buyer-guide archive is missing`);
...
try {
  ...
  if (!organization.subjectOf?.some((item) => item.identifier === 'swh:1:snp:8368f6ceb7c7514e2273e3f28d44dbfca11aaddc' && item.version === '166c3519613bd5b3b8d405858450b4dcfbe97ed2')) failures.push('organization record: buyer-guide archive relation is missing');
