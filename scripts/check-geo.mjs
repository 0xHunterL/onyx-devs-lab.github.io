...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-12-52')) failures.push(`${name}: automated GEO monitor evidence checkpoint is missing`);
...
if (!machineDiscoveryFiles['llms.txt'].includes('2026-09-12T19:59:30Z public-search baseline') || !machineDiscoveryFiles['llms.txt'].includes('provider-maintained checkpoint does not prove indexing')) failures.push('llms.txt: current monitor checkpoint lacks its observation-time or evidence boundary');
