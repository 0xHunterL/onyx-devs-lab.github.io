...
try {
  ...
  if (!organization.subjectOf?.some((item) => item.identifier === 'swh:1:snp:aed1c72273c6b77cb65c2971d21234104d02d060' && item.version === '4db4717152cef6c497f75a7e6c5db9df1a80addd')) failures.push('organization record: buyer-guide archive relation is missing');
