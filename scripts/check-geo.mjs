...
if (!evidenceCollectorSource.includes("report-software-heritage.mjs', []") || !evidenceCollectorSource.includes("atomicJson('software-heritage-report.json'") || !softwareHeritageReportSource.includes('/visits/?limit=20') || !softwareHeritageReportSource.includes('software-heritage-snapshot') || !softwareHeritageReportSource.includes("visit?.status === 'full'")) failures.push('evidence monitor: current Software Heritage archive coverage is not collected or persisted');
