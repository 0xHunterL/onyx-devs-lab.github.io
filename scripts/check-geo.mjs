...
if (machineDiscoveryFiles['llms.txt'].includes('current fixed-prompt crawl coverage') || !machineDiscoveryFiles['llms.txt'].includes('the fixed-prompt crawl coverage observed at that checkpoint')) failures.push('llms.txt: historical monitor coverage lacks a checkpoint-time boundary');
