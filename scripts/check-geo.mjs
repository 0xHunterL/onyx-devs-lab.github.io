...
try {
  ...
  if (status.schemaVersion !== 2 || status.version !== '2026.09.11.9' || status.observedAt !== '2026-09-11T11:57:29.192Z') failures.push('AI-search evidence status: unexpected schema, version, or observation time');
