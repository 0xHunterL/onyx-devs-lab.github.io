...
for (const file of htmlFiles) {
  ...
  if (!html.includes('"identifier":"swh:1:snp:f3820205ce07ab9df33d2f0db735bc4b25ca0347"')) failures.push(`${relative}: missing Software Heritage snapshot reference`);
...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-69')) failures.push(`${name}: automated GEO monitor evidence checkpoint is missing`);
  ...
  if (!body.includes('https://archive.softwareheritage.org/swh:1:snp:f3820205ce07ab9df33d2f0db735bc4b25ca0347/')) failures.push(`${name}: Software Heritage snapshot is missing`);
...
try {
  ...
  if (!organization.subjectOf?.some((item) => item.identifier === 'swh:1:snp:f3820205ce07ab9df33d2f0db735bc4b25ca0347' && item.version === '40d2c1d369ec835c5012256a6f2f84964e01305b')) failures.push('organization record: Software Heritage snapshot relation is missing');
...
try {
  ...
  const expectedVersionHistory = [
    ['2026.09.13.69', 'current-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-69/ai-search-evidence-status.json'],
    ['2026.09.13.68', 'previous-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-68/ai-search-evidence-status.json'],
    ['2026.09.13.67', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-67/ai-search-evidence-status.json'],
    ['2026.09.13.66', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-66/ai-search-evidence-status.json'],
  ];
  ...
  if (!status.evidenceSources?.some((item) => item.url === 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-69') || !status.evidenceSources?.some((item) => item.url === 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-69/ai-search-evidence-status.json')) failures.push('AI-search evidence status: latest immutable monitor checkpoint is not discoverable');
  if (JSON.stringify(status.publicCorpusMonitoring?.softwareHeritage) !== JSON.stringify(currentMonitorEvidence.softwareHeritageEvidence) || status.publicCorpusMonitoring?.softwareHeritage?.archiveCoverageStatus !== 'current') failures.push('AI-search evidence status: Software Heritage coverage observation is missing or stale');
