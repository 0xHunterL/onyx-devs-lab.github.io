...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-14-76')) failures.push(`${name}: automated GEO monitor evidence checkpoint is missing`);
...
try {
  ...
  const expectedVersionHistory = [
    ['2026.09.14.76', 'current-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-14-76/ai-search-evidence-status.json'],
    ['2026.09.13.75', 'previous-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-75/ai-search-evidence-status.json'],
    ...
    ['2026.09.13.73', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-73/ai-search-evidence-status.json'],
  ];
