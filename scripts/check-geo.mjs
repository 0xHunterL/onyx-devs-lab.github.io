...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-71')) failures.push(`${name}: automated GEO monitor evidence checkpoint is missing`);
...
try {
  ...
  const expectedVersionHistory = [
    ['2026.09.13.71', 'current-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-71/ai-search-evidence-status.json'],
    ['2026.09.13.70', 'previous-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-70/ai-search-evidence-status.json'],
    ['2026.09.13.69', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-69/ai-search-evidence-status.json'],
    ['2026.09.13.68', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-68/ai-search-evidence-status.json'],
  ];
