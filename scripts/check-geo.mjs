...
try {
  ...
  if (status.schemaVersion !== 2 || status.version !== '2026.09.11.10' || status.observedAt !== '2026-09-11T12:16:01Z') failures.push('AI-search evidence status: unexpected schema, version, or observation time');
