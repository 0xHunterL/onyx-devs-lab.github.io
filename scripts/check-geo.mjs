...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-monitor-evidence-2026-09-13-75')) failures.push(`${name}: automated GEO monitor evidence checkpoint is missing`);
...
try {
  ...
  const expectedVersionHistory = [
    ['2026.09.13.75', 'current-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-75/ai-search-evidence-status.json'],
    ['2026.09.13.74', 'previous-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-74/ai-search-evidence-status.json'],
    ...
    ['2026.09.13.72', 'earlier-immutable-checkpoint', 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-13-72/ai-search-evidence-status.json'],
  ];
...
if (!machineDiscoveryFiles['feed.xml'].includes('<updated>2026-09-13T00:00:00+08:00</updated>')) failures.push('feed.xml: feed update date is stale');
