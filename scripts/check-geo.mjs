...
try {
  ...
  if (currentPublicSearchRetest.nonBrandCategoryResultsObserved?.length !== 11 || !currentPublicSearchRetest.nonBrandCategoryResultsObserved.some((item) => item.url === 'https://www.fde.hk/zh-hk') || !currentPublicSearchRetest.nonBrandCategoryMeaning?.includes('not a complete ranking')) failures.push('AI-search evidence status: non-brand category result baseline is missing or misleading');
