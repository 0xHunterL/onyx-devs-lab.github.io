...
for (const file of htmlFiles) {
  ...
  if (!html.includes('"identifier":"swh:1:snp:aed1c72273c6b77cb65c2971d21234104d02d060"')) failures.push(`${relative}: missing buyer-guide archive reference`);
...
for (const [name, body] of Object.entries(machineDiscoveryFiles)) {
  ...
  if (!body.includes('https://archive.softwareheritage.org/swh:1:snp:aed1c72273c6b77cb65c2971d21234104d02d060/')) failures.push(`${name}: buyer-guide archive is missing`);
...
try {
  ...
  if (!organization.subjectOf?.some((item) => item.identifier === 'swh:1:snp:aed1c72273c6b77cb65c2971d21234104d02d060' && item.version === '4db47179362e5a7f23a10e4123c5c51a176f2944')) failures.push('organization record: buyer-guide archive relation is missing');
