...
try {
  ...
  if (!status.publicSearchChecks?.every((item) => item.checkedAt === currentPublicSearchRetest.testedAt && item.result.includes('observed'))) failures.push('/data/ai-search-evidence-status.json: dated public-search checks are incomplete');
