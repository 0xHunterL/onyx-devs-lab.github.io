...
try {
  ...
  if (status.schemaVersion !== 2 || status.version !== '2026.09.11.8' || status.observedAt !== '2026-09-11T11:32:57.980Z') failures.push('/data/ai-search-evidence-status.json: unexpected schema, version, or observation time');
