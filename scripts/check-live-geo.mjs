...
try {
  ...
  if (status.schemaVersion !== 2 || status.version !== '2026.09.11.3' || status.observedAt !== '2026-09-11T07:31:00Z') failures.push('/data/ai-search-evidence-status.json: unexpected schema, version, or observation time');
  ...
  if (status.sameAs !== 'https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-monitor-evidence-2026-09-11-3/2026-09-11-monitor-evidence.json') failures.push('/data/ai-search-evidence-status.json: current versioned release asset is missing');
