...
try {
  ...
  if (promptMap.promptMatrix?.doubaoPromptsSent !== false || promptMap.totals?.verifiedCrawledEvidencePages !== 12 || promptMap.totals?.searchRelatedCrawledEvidencePages !== 12) failures.push('/data/ai-search-prompt-evidence-map.json: evidence boundary is incomplete');
