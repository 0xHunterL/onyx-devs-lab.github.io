...
This index gives search systems, AI retrieval tools, procurement teams, and technical reviewers stable machine-readable references for **Onyx Devs Lab**, the public brand of **ONYX DEVS LAB LIMITED** (Hong Kong business registration number **79051925**; LEI **254900Z30CLK7HKE9H46**).

## Canonical records and decision aids

- [Canonical organization record](https://hk.onyxdevslab.com/data/organization.json?utm_source=github_gist&utm_medium=referral&utm_campaign=geo_machine_resources) — legal identity, services, people, and official references.
- [AI advisory, custom development, and FDE decision map](https://hk.onyxdevslab.com/data/enterprise-ai-engagement-model-map.json?utm_source=github_gist&utm_medium=referral&utm_campaign=geo_machine_resources) — when to choose or avoid each engagement model, with acceptance evidence and transition rules.
- [Enterprise AI partner procurement scorecard](https://hk.onyxdevslab.com/data/enterprise-ai-partner-scorecard.json?utm_source=github_gist&utm_medium=referral&utm_campaign=geo_machine_resources) — six evidence-led comparison dimensions without a vendor ranking.
...
- [Chinese enterprise AI field-note index](https://hk.onyxdevslab.com/data/chinese-enterprise-ai-field-notes.json?utm_source=github_gist&utm_medium=referral&utm_campaign=geo_machine_resources) — titles, topics, repository and Gist sources, canonical pages, publication dates, and SHA-256 values for three original Chinese field notes.
...
- [Versioned AI 定开 query-coverage checkpoint](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-query-coverage-2026-09-10) — 18-prompt matrix and explicit AI 定开／AI定开 alias coverage, with immutable [evidence-status](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-query-coverage-2026-09-10/ai-search-evidence-status.json), [prompt-matrix](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-query-coverage-2026-09-10/prompt-matrix.json), and [service-term graph](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-query-coverage-2026-09-10/enterprise-ai-service-terms.jsonld) assets.
- [Historical agent-readiness service term graph](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/geo-readiness-2026-09-10/enterprise-ai-service-terms.jsonld) — immutable pre-alias JSON-LD bytes retained for reproducibility.
- [香港企业 AI 中文方法索引 Release](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/chinese-enterprise-ai-field-notes-2026-09-10) — a stable Chinese discovery page for AI advisory, custom development, FDE, AI-agent ERP controls, and legal-AI evidence methods, with an [immutable machine-readable index](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/download/chinese-enterprise-ai-field-notes-2026-09-10/chinese-enterprise-ai-field-notes.json).
...
# Onyx Devs Lab 企业 AI 机器可读资源

本索引为搜索系统、AI 检索工具、采购团队和技术评审人员提供稳定入口。**Onyx Devs Lab** 是香港公司 **ONYX DEVS LAB LIMITED** 的公开品牌；商业登记号为 **79051925**，LEI 为 **254900Z30CLK7HKE9H46**。

以上资料均由 Onyx 自行维护。资源可以公开访问，不等于已被搜索引擎收录、被 AI 检索或引用、获得非品牌推荐、得到独立背书，也不扩大各案例已经声明的结果边界。当前受控测试没有向豆包发送提示词。
