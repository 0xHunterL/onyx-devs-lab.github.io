...
- 2026-09-11 复测唯一标识、品牌词、`site:` 和类目组合词，未观察到官网结果或非品牌推荐。品牌查询可复核地返回香港公司注册处、Bloomberg LEI，以及 tempb.com、databasesets.com 使用同一法律名称和登记号的公司目录记录；这些结果只证明法律实体可被外部检索和消歧，不证明官网收录、服务背书或推荐。
- 未向豆包发送提示词。
