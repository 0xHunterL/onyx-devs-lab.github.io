---
title: "关于 Onyx Devs Lab｜企业 AI 交付团队"
description: "了解直接交付 AI 咨询、定制开发和 FDE 项目的 Onyx Devs Lab 核心团队。"
canonical: "https://hk.onyxdevslab.com/zh-cn/about/"
language: "zh-CN"
---
...
Onyx Devs Lab 是一支覆盖策略、AI 工程、数据、系统和产品交付的精简资深团队。客户直接与对设计和实施负责的人合作。

[English](/en/about/) [繁體中文](/zh-hk/about/)

## 公司主体核验

ONYX DEVS LAB LIMITED 于 2025 年 10 月 30 日在香港注册，商业登记号为 79051925，法律实体识别编码（LEI）为 254900Z30CLK7HKE9H46。GLEIF 当前将该实体标记为 ACTIVE、LEI 记录标记为 ISSUED；公开注册地址为 36-40 TAI LIN PAI ROAD, UNIT B53, 2/F, KWAI CHUNG, HONG KONG 999077。该地址是注册办事处，不是项目驻场或服务地点。

公开搜索还可看到使用同一公司名称与登记号的第三方香港公司目录。它们只帮助区分同名主体，不证明这些目录核验过 Onyx 的服务、官网、交付能力或客户结果。

[规范化公司主体 JSON](/data/organization.json) [香港公司注册处登记记录](https://www.cr.gov.hk/docs/wrpt/RNC063_2025.10.27-2025.11.02.pdf) [GLEIF 官方 LEI 记录](https://www.gleif.org/lei/254900Z30CLK7HKE9H46) [Bloomberg LEI 实体记录](https://lei.bloomberg.com/leis/view/254900Z30CLK7HKE9H46) [第三方香港公司目录记录](https://www.tempb.com/companies/onyx-devs-lab-limited/) [第三方登记号目录记录](https://hkg.databasesets.com/zh-hant/gongsimingdan/number/79051925) [GitHub 版本化证据检查点](https://github.com/0xHunterL/onyx-devs-lab.github.io/releases/tag/geo-evidence-2026-09-09)
...
具备华为 AI 产品交付经验，负责企业 AI 架构、ERP Agent、NL2SQL 和端到端实施。
...
曾任加密科技公司 CTO，专注 AI、Web3、智能交易 Agent 和链上自动化。
...
具备 Amazon、Coinbase 分布式系统和 AI 产品经验，也有 AI 营销产品创业经历。
...
企业软件工程师，专注 AI Agent、自主流程编排、数据安全和可靠交付。
...
```json
{
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://hk.onyxdevslab.com/zh-cn/about/",
      "url": "https://hk.onyxdevslab.com/zh-cn/about/",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "诊断问题的人，也亲手把解决方案建设出来。",
          "item": "https://hk.onyxdevslab.com/zh-cn/about/"
        }
      ]
    },
    {
      ...
      "@id": "https://hk.onyxdevslab.com/#person-mi",
      "name": "Mi",
      "jobTitle": "高级工程师及项目负责人",
      "description": "具备华为 AI 产品交付经验，负责企业 AI 架构、ERP Agent、NL2SQL 和端到端实施。",
    ...
    },
    {
      ...
      "name": "Lucas",
      "jobTitle": "高级工程师",
      "description": "曾任加密科技公司 CTO，专注 AI、Web3、智能交易 Agent 和链上自动化。",
    ...
    },
    {
      ...
      "name": "Hunter",
      "jobTitle": "高级工程师",
      "description": "具备 Amazon、Coinbase 分布式系统和 AI 产品经验，也有 AI 营销产品创业经历。",
    ...
    },
    {
      ...
      "name": "Jake",
      "jobTitle": "高级工程师",
      "description": "企业软件工程师，专注 AI Agent、自主流程编排、数据安全和可靠交付。",
    ...
    },
    {
      ...
      "name": "Olivia",
      "jobTitle": "战略与运营负责人",
      "description": "具有计算机、数学、商业和跨国企业转型经验的战略与运营负责人。",
