...
GPTBot 已驗證正文請求 28 次；所有已核驗爬蟲合計覆蓋 45 個標準正文路徑。Wayback 公開 CDX 另記錄 94 條成功 HTML 捕獲，覆蓋 44 個 URL；固定提示詞的 23 個唯一證據頁中已有 16 頁歸檔，12 條提示詞的全部證據頁均已歸檔。23 條固定提示詞中 18 條至少一個證據頁被核驗爬取、12 條全部證據頁被爬取；搜尋／檢索相關爬蟲覆蓋為 18/23。
