---
title: "零售 AI 決策平台案例｜Onyx Devs Lab"
description: "在不更換既有 ERP 的前提下，建立支援庫存、人力及商品組合決策的數據與 AI 層。"
canonical: "https://hk.onyxdevslab.com/zh-hk/case-studies/retail-ai-decision-platform/"
language: "zh-Hant-HK"
---
...
企業已有交易數據，但庫存、人力及損耗訊號分散。項目需要改善決策，同時避免高風險的核心 ERP 替換。
...
```json
{
  ...
  "@graph": [
    ...
    {
      "@type": "Article",
      "@id": "https://hk.onyxdevslab.com/zh-hk/case-studies/retail-ai-decision-platform/#primary",
      "name": "把零售交易數據轉化為營運決策",
      "description": "在不更換既有 ERP 的前提下，建立支援庫存、人力及商品組合決策的數據與 AI 層。",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "把零售交易數據轉化為營運決策",
          "item": "https://hk.onyxdevslab.com/zh-hk/case-studies/retail-ai-decision-platform/"
        }
      ]
    }
  ]
