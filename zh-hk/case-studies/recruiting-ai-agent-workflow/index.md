---
title: "香港招聘 AI Agent 工作流案例｜Onyx Devs Lab"
description: "涵蓋候選人同步、證據化畫像、回覆草擬、冪等發送及人工接管的受控招聘 Agent 工作流。"
canonical: "https://hk.onyxdevslab.com/zh-hk/case-studies/recruiting-ai-agent-workflow/"
language: "zh-Hant-HK"
---
...
快速生成回覆不能解決對話不完整、候選人畫像過期、重複發送或發送狀態不確定。自動化需要與招聘顧問共同工作，而不是搶佔日常界面。

## 系統干預

01

以本地 Connector 復用已授權招聘登入狀態並同步可見歷史。

02

上下文變化時刷新結構化畫像，區分事實、推斷、置信度及缺失信息。

03

按候選人提供人工、Copilot 及受控 Autopilot 模式。

04

發送任務串行且冪等，並回讀已發消息確認完成。
...
首次查看至確認下一步；此前為 22.4 分鐘

## 證據邊界

公開驗證涵蓋受控試點中的同步、發送確認及工作流時間；在缺少更長招聘群組前，不主張改善最終招聘結果。
...
```json
{
  ...
  "@graph": [
    ...
    {
      "@type": "Article",
      "@id": "https://hk.onyxdevslab.com/zh-hk/case-studies/recruiting-ai-agent-workflow/#primary",
      "name": "具備上下文、證據及發送控制的招聘自動化",
      "description": "涵蓋候選人同步、證據化畫像、回覆草擬、冪等發送及人工接管的受控招聘 Agent 工作流。",
      ...
      "mainEntityOfPage": {
        "@id": "https://hk.onyxdevslab.com/zh-hk/case-studies/recruiting-ai-agent-workflow/"
      },
      "articleSection": "案例研究"
    },
    {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "具備上下文、證據及發送控制的招聘自動化",
          "item": "https://hk.onyxdevslab.com/zh-hk/case-studies/recruiting-ai-agent-workflow/"
        }
      ]
    }
  ]
