...
const copy = {
  zh: {
    ...
    title: '不是从功能清单开始，',
    accent: '而是从业务现场开始',
    intro: '我们把咨询诊断、系统设计与一线交付放在同一条链路中：先建立事实，再定位约束，最后用可验证的系统改变真实工作。',
    stats: [['32', '种分析工具'], ['6', '个交付阶段'], ['8', '个 FDE 案例']],
    route: '每个项目都沿同一条证据链推进',
    proof: '每一步都形成可审阅的中间产物，下一步决策有来源，最终结果有验证方式。',
    cta: '查看 13 个项目如何应用这套方法',
  },
  en: {
    eyebrow: 'ONYX FDE DELIVERY SYSTEM',
    title: 'We do not start with features. ',
    accent: 'We start in the field.',
    intro: 'Our FDE practice connects consulting diagnosis, system design, and frontline delivery in one evidence-led route.',
    stats: [['32', 'analysis tools'], ['6', 'delivery stages'], ['8', 'FDE engagements']],
  ...
  it: {
    eyebrow: 'ONYX FDE DELIVERY SYSTEM',
    title: 'Non partiamo dalle funzionalità. ',
    accent: 'Partiamo dal lavoro reale.',
    intro: 'Il nostro approccio FDE unisce diagnosi, progettazione e delivery sul campo in un unico percorso basato sulle evidenze.',
    stats: [['32', 'strumenti'], ['6', 'fasi'], ['8', 'progetti FDE']],
